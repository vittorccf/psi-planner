...
EXP = {
    ...
    "recebido": 1560,
    "pendente": 350,
    "lucro": 1560 - sum(DESPESAS),   # 101
    "inadimplencia": 350 / (1560 + 350),
    "fat_anual": 1560,
    "faltas": 1,
...
try:
    ...
    try:
        ...
        check(pacv == "Ana Beatriz Souza", "recibo paciente = %r" % pacv)
...
if not os.path.exists(SPEC_HTML):
    ...
    markers = ["Especificação Visual da Planilha", "Psi <span class=\"wine\">Planner</span>",
               "Estrutura geral", "Identidade visual", "Paleta oficial", "Tipografia",
               "Notas técnicas", "Saluti · Projeto Psi Planner"]
    for mk in markers:
