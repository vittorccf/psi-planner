...
OUT_XLSX = r"D:\Vittor\Projetos\Saluti\PsiPlanner\build2\PsiPlanner2_base.xlsx"
...
PACIENTES = [
    ("Ana Beatriz Souza","284.915.370-22","12.845.013-7",D(1990,3,10),"(62) 98111-2222","ana.souza@email.com","R. das Flores, 120 - Goiânia/GO","Particular","Arquiteta",D(2025,9,15),"Semanal",180,"Ativo",12,9,D(2026,5,4)),
    ("Bruno Carvalho","417.062.853-90","23.701.594-2",D(1988,5,15),"(62) 98222-3333","bruno.c@email.com","Av. T-63, 800 - Goiânia/GO","Unimed","Engenheiro",D(2025,11,2),"Semanal",180,"Ativo",10,7,D(2026,5,6)),
    ("Camila Diniz","538.274.916-04","31.928.460-5",D(1992,5,28),"(62) 98333-4444","camila.d@email.com","R. 7, 45 - Anápolis/GO","Particular","Professora",D(2026,1,20),"Quinzenal",150,"Ativo",8,3,D(2026,5,11)),
    ("Diego Esteves","692.103.748-51","44.560.182-9",D(1995,7,8),"(62) 98444-5555","diego.e@email.com","R. 9, 300 - Goiânia/GO","Particular","Designer",D(2026,2,12),"Semanal",200,"Pausado",6,4,D(2026,4,15)),
    ("Eduarda Faria","703.418.625-37","15.673.209-4",D(1991,5,30),"(62) 98555-6666","edu.faria@email.com","Av. 85, 1500 - Goiânia/GO","Bradesco","Médica",D(2025,8,25),"Semanal",180,"Ativo",20,16,D(2026,5,18)),
    ("Fernando Gomes","865.290.143-78","26.084.751-3",D(1989,6,12),"(62) 98666-7777","fer.gomes@email.com","R. C-140, 22 - Goiânia/GO","Particular","Advogado",D(2025,12,1),"Quinzenal",180,"Ativo",10,5,D(2026,5,22)),
    ("Gabriela Hoffmann","129.576.430-86","37.215.608-1",D(1994,9,25),"(62) 98777-8888","gabi.h@email.com","R. 1004, 60 - Goiânia/GO","SulAmérica","Publicitária",D(2026,3,3),"Semanal",180,"Ativo",8,6,D(2026,5,25)),
    ("Kris Fellipe","954.380.217-69","48.902.136-0",D(1986,6,3),"(62) 98888-9999","kris.fellipe@email.com","UBS Turvânia - Turvânia/GO","Particular","Dentista (UBS)",D(2026,1,10),"Mensal",150,"Ativo",6,2,D(2026,5,20)),
]

# Financeiro lançamentos: (Data,Paciente,Tipo,Forma,Valor,Status,NF,NumNF,Obs)
FIN = [
    (D(2026,1,8),"Eduarda Faria","Sessão online","Pix",180,"Pago","Emitida","2026-012",""),
    (D(2026,1,15),"Bruno Carvalho","Sessão online","Cartão",180,"Pago","Emitida","2026-018",""),
    (D(2026,1,20),"Ana Beatriz Souza","Sessão presencial","Pix",180,"Pago","Emitida","2026-021","Recibo Receita Saúde"),
    (D(2026,1,27),"Fernando Gomes","Sessão presencial","Cartão",180,"Pago","Emitida","2026-027",""),
    (D(2026,2,5),"Ana Beatriz Souza","Sessão presencial","Pix",180,"Pago","Emitida","2026-034","Recibo Receita Saúde"),
    (D(2026,2,12),"Eduarda Faria","Sessão online","Pix",180,"Pago","Emitida","2026-041",""),
    (D(2026,2,18),"Bruno Carvalho","Sessão online","Cartão",180,"Pago","Emitida","2026-048",""),
    (D(2026,2,24),"Camila Diniz","Sessão presencial","Dinheiro",150,"Pago","Não emitida","","Pagamento em espécie"),
    (D(2026,3,4),"Ana Beatriz Souza","Sessão presencial","Pix",180,"Pago","Emitida","2026-056","Recibo Receita Saúde"),
    (D(2026,3,11),"Bruno Carvalho","Sessão online","Cartão",180,"Pago","Emitida","2026-062",""),
    (D(2026,3,17),"Camila Diniz","Sessão presencial","Dinheiro",150,"Pago","Não emitida","","Pagamento em espécie"),
    (D(2026,3,25),"Eduarda Faria","Sessão online","Pix",180,"Pago","Emitida","2026-071",""),
    (D(2026,4,2),"Ana Beatriz Souza","Sessão presencial","Pix",180,"Pago","Emitida","2026-079","Recibo Receita Saúde"),
    (D(2026,4,9),"Bruno Carvalho","Sessão online","Cartão",180,"Pago","Emitida","2026-085",""),
    ...
    (D(2026,4,23),"Camila Diniz","Sessão presencial","Dinheiro",150,"Pago","Não emitida","","Pagamento em espécie"),
...
DESP = [
    (D(2026,5,2),"Plataforma online","Assinatura Psi Planner 2 Pro",99,"Cartão"),
...
# Histórico de sessões já realizadas (alimenta "atendimentos por mês"; fora da grade da semana)
CAL_HIST = [
    (D(2026,1,6),"08:00","Ana Beatriz Souza","Presencial","Realizado"),
    (D(2026,1,9),"10:00","Eduarda Faria","Online","Realizado"),
    (D(2026,1,13),"14:00","Bruno Carvalho","Online","Realizado"),
    (D(2026,1,16),"11:00","Fernando Gomes","Presencial","Realizado"),
    (D(2026,1,23),"15:00","Camila Diniz","Presencial","Realizado"),
    (D(2026,1,28),"16:00","Gabriela Hoffmann","Online","Realizado"),
    (D(2026,2,3),"09:00","Ana Beatriz Souza","Presencial","Realizado"),
    (D(2026,2,6),"10:00","Bruno Carvalho","Online","Realizado"),
    (D(2026,2,13),"14:00","Eduarda Faria","Online","Realizado"),
    (D(2026,2,17),"11:00","Fernando Gomes","Presencial","Realizado"),
    (D(2026,2,20),"16:00","Camila Diniz","Presencial","Realizado"),
    (D(2026,2,24),"15:00","Ana Beatriz Souza","Presencial","Realizado"),
    (D(2026,3,5),"10:00","Ana Beatriz Souza","Presencial","Realizado"),
    (D(2026,3,9),"08:00","Bruno Carvalho","Online","Realizado"),
    (D(2026,3,12),"11:00","Eduarda Faria","Online","Realizado"),
    (D(2026,3,17),"14:00","Camila Diniz","Presencial","Realizado"),
    (D(2026,3,24),"16:00","Fernando Gomes","Presencial","Realizado"),
    (D(2026,3,26),"15:00","Gabriela Hoffmann","Online","Realizado"),
    (D(2026,4,2),"09:00","Ana Beatriz Souza","Presencial","Realizado"),
    (D(2026,4,7),"10:00","Bruno Carvalho","Online","Realizado"),
    (D(2026,4,10),"14:00","Eduarda Faria","Online","Realizado"),
    (D(2026,4,16),"11:00","Camila Diniz","Presencial","Realizado"),
    (D(2026,4,21),"16:00","Fernando Gomes","Presencial","Realizado"),
    (D(2026,4,24),"15:00","Ana Beatriz Souza","Presencial","Realizado"),
]
...
for (col, row, pac, tipo, status, data, hora) in CAL:
    c = ws[f"{col}{row}"]
    c.value = f"{pac}\n{tipo} · {status}"
    c.font = mkfont("conteudo_pequeno", "000000")
...
for j, (data, hora, pac, tipo, status) in enumerate(CAL_HIST):
    lr = 100 + len(CAL) + j
    ws[f"A{lr}"].value = data; ws[f"A{lr}"].number_format = "dd/mm/yyyy"
    ws[f"B{lr}"].value = hora; ws[f"C{lr}"].value = pac
    ws[f"D{lr}"].value = tipo; ws[f"E{lr}"].value = status
    for col in ("A","B","C","D","E"):
        ws[f"{col}{lr}"].font = mkfont("conteudo_pequeno", "3B3B3B")
...
fin["M9"].alignment = Alignment(horizontal="right", vertical="center", indent=1)
...
fin["L12"].value = "Total despesas"
fin["L12"].font = mkfont("kpi_label", "3B3B3B")
fin["L12"].alignment = ALIGN("left","center")
fin["L12"].fill = PatternFill(fill_type="solid", fgColor=argb(PAL["cinza_claro"]))
fin["M12"].value = "=SUM(DESP_Valor)"
fin["M12"].number_format = 'R$ #,##0.00'
fin["M12"].font = mkfont("kpi_valor_pequeno", "000000")
fin["M12"].alignment = Alignment(horizontal="right", vertical="center", indent=1)
fin["M12"].fill = PatternFill(fill_type="solid", fgColor=argb(PAL["cinza_claro"]))
...
aviso_blocks = [
    ...
    ("J9","J9:K10","AVISO_MEI",
     '=IF(MEI_Faturamento>=72900,"Crítico: ",IF(MEI_Faturamento>=56700,"Atenção: ",""))&"Faturamento anual R$ "&FIXED(MEI_Faturamento,0)&" / teto MEI R$ 81.000"'),
...
for ref, mrange, nm, formula in aviso_blocks:
    ...
    try:
        ...
        pass
    # marcador cognac na coluna I — mesclado nas MESMAS linhas do texto e
    # centralizado, para a bolinha alinhar com o texto (não flutuar no topo)
    import re as _re_av
    _endrow = _re_av.search(r"\d+$", mrange).group()
    _brange = "I%s:I%s" % (ref[1:], _endrow)
    try:
        menu.merge_cells(_brange)
    except Exception:
        pass
    mk = menu["I" + ref[1:]]
    mk.value = "•"
    mk.font = Font(name="Poppins Light", size=11, color=argb(PAL["vinho_elegante"]))
    mk.alignment = ALIGN("center", "center")

# --- refinamento visual do Menu (otimização premium) ---
_menu_heights = {1:18,2:40,3:22,4:14,5:22,6:24,7:46,8:10,9:22,10:24,
                 11:54,12:14,13:54,14:12,15:8,16:8,17:8,18:8,19:8,20:8}
for _r, _h in _menu_heights.items():
    menu.row_dimensions[_r].height = _h
# eyebrow do produto acima do nome da clínica (marca discreta, não protagonista)
menu["B1"].value = "PSI PLANNER 2"
menu["B1"].font = Font(name="Poppins Light", size=9, bold=False,
                       italic=False, color=argb(PAL["vinho_elegante"]))
menu["B1"].alignment = ALIGN("left", "bottom")
menu.row_dimensions[1].height = 16
...
# card crítico (Valor pendente): o sinal é a COR cognac do próprio valor (D7),
# sem sublinhado solto (removido por feedback de cliente — parecia defeito).
...
cal["B3"].value = ('="Semana de "&TEXT(TODAY()-WEEKDAY(TODAY(),2)+1,"dd/mm")&" a "&'
                  'TEXT(TODAY()-WEEKDAY(TODAY(),2)+6,"dd/mm")&" · agenda de atendimentos"')
...
conv = ["Particular","Unimed","Bradesco","SulAmérica","Outros"]
...
add_dv(pac, "J7:J56", ["Particular","Unimed","Bradesco","SulAmérica","Amil"])
...
# Financeiro status (tints suaves + texto escuro — badge, não bloco)
contains_rule(fin, "G7:G56", "G7", "Pago", "done", "000000")
contains_rule(fin, "G7:G56", "G7", "Pendente", "wait", "000000")
contains_rule(fin, "G7:G56", "G7", "Lembrete", "surface_deep", "3B3B3B")
contains_rule(fin, "G7:G56", "G7", "Cancelado", "alert", "3A1018")
...
# Pacientes status
contains_rule(pac, "O7:O56", "O7", "Ativo", "done", "000000")
contains_rule(pac, "O7:O56", "O7", "Pausado", "wait", "000000")
contains_rule(pac, "O7:O56", "O7", "Alta", "surface_deep", "3B3B3B")
contains_rule(pac, "O7:O56", "O7", "Inativo", "alert", "3A1018")
# Calendário status (na grade) — tints suaves
contains_rule(cal, "C6:H21", "C6", "Cancelado", "alert", "3A1018")
contains_rule(cal, "C6:H21", "C6", "Faltou", "alert", "3A1018")
contains_rule(cal, "C6:H21", "C6", "Confirmado", "done", "000000")
contains_rule(cal, "C6:H21", "C6", "Realizado", "surface_deep", "000000")
...
contains_rule(aniv, "H7:H56", "H7", "Sim", "done", "000000")
contains_rule(aniv, "H7:H56", "H7", "Não", "surface_deep", "3B3B3B")
...
# ---------------------------------------------------------------------------
# rampa quente coesa (warm taupe) + vinho — estudo de cor
VINHO = "5A1E2A"; CINZA_M = "9A9A9A"; CINZA_E = "6B6B6B"; CINZA_C = "EAEAEA"; PRETO = "000000"

def set_series_color(s, hexcolor):
    s.graphicalProperties.solidFill = hexcolor
    s.graphicalProperties.line.solidFill = hexcolor

# --- Onda 4: tipografia de gráfico coerente (Cambria/Segoe + mute) ---
def _chart_title(text):
    cp = CharacterProperties(latin=DrawFont(typeface="Playfair Display"), sz=1100, b=False, i=False, solidFill="3B3B3B")
    para = Paragraph(pPr=ParagraphProperties(defRPr=cp), r=[RegularTextRun(rPr=cp, t=text)])
    return Title(tx=Text(rich=RichText(p=[para])))

def _axis_style(ch):
    cp = CharacterProperties(latin=DrawFont(typeface="Poppins Light"), sz=800, solidFill="3B3B3B")
...
def _chart_frame(ch):
    ch.graphical_properties = GraphicalProperties(ln=LineProperties(solidFill="E2E2E2"))

from openpyxl.chart.label import DataLabelList

def add_line(ws, title, anchor, data_ref, cats_ref, color=CINZA_M):
    ch = LineChart(); ch.title = _chart_title(title); ch.title.overlay = False; ch.style = 2
    ...
    ch.y_axis.scaling.min = 0          # eixo começa em 0 (não engana)
    _axis_style(ch); _chart_frame(ch)
    ws.add_chart(ch, anchor)

def add_bar_h(ws, title, anchor, data_ref, cats_ref, color=CINZA_M):
    ch = BarChart(); ch.type = "bar"; ch.title = _chart_title(title); ch.title.overlay = False; ch.style = 2
    ch.height = 6; ch.width = 9
    ch.add_data(data_ref, titles_from_data=True)
    ch.set_categories(cats_ref)
    for s in ch.series:
    ...
    ch.y_axis.delete = False
    ch.x_axis.delete = False
    ch.y_axis.scaling.min = 0          # no openpyxl o eixo de VALOR é sempre y_axis (mesmo na barra horizontal) — começa em 0
    _axis_style(ch); _chart_frame(ch)
    ws.add_chart(ch, anchor)

def add_doughnut(ws, title, anchor, data_ref, cats_ref, colors, show_pct=True):
    ch = DoughnutChart(); ch.title = _chart_title(title); ch.title.overlay = False; ch.holeSize = 58
    ch.height = 6; ch.width = 9
    ch.add_data(data_ref, titles_from_data=True)
    ch.set_categories(cats_ref)
    s = ch.series[0]
    ...
    if show_pct:                       # rótulos de % nas fatias (dashboard premium)
...
add_line(fin, "Receita mensal", "B78", Reference(fin, min_col=29, min_row=1, max_row=6), Reference(fin, min_col=28, min_row=2, max_row=6), VINHO)
add_bar_h(fin, "Receita x Despesa", "F78", Reference(fin, min_col=32, min_row=1, max_row=3), Reference(fin, min_col=31, min_row=2, max_row=3))
add_doughnut(fin, "Pago x Pendente", "J78", Reference(fin, min_col=35, min_row=1, max_row=3), Reference(fin, min_col=34, min_row=2, max_row=3), [VINHO, CINZA_M])
add_line(fin, "Evolução acumulada", "B96", Reference(fin, min_col=38, min_row=1, max_row=6), Reference(fin, min_col=37, min_row=2, max_row=6), VINHO)
add_doughnut(fin, "Distribuição por forma", "F96", Reference(fin, min_col=41, min_row=1, max_row=5), Reference(fin, min_col=40, min_row=2, max_row=5), [CINZA_E, CINZA_M, VINHO, CINZA_C])

# Relatórios: 3 gráficos
add_line(rel, "Evolução da receita", "B16", Reference(rel, min_col=29, min_row=1, max_row=6), Reference(rel, min_col=28, min_row=2, max_row=6), VINHO)
add_bar_h(rel, "Atendimentos por mês", "E16", Reference(rel, min_col=32, min_row=1, max_row=7), Reference(rel, min_col=31, min_row=2, max_row=7))
add_doughnut(rel, "Receita por convênio", "H16", Reference(rel, min_col=35, min_row=1, max_row=6), Reference(rel, min_col=34, min_row=2, max_row=6), [CINZA_E, CINZA_M, VINHO, CINZA_C, PRETO])

# Aniversariantes: 1 doughnut
add_doughnut(aniv, "Aniversariantes por mês", "J8", Reference(aniv, min_col=29, min_row=1, max_row=13), Reference(aniv, min_col=28, min_row=2, max_row=13),
             [CINZA_C, CINZA_M, CINZA_E, VINHO, CINZA_C, CINZA_M, CINZA_E, VINHO, CINZA_C, CINZA_M, CINZA_E, VINHO], show_pct=False)
...
for _r in range(6, 22):
    cal.row_dimensions[_r].height = 30
...
# ---------------------------------------------------------------------------
for _ws in sheets.values():
    _ws.oddFooter.left.text = "Psi Planner 2"   # marca do produto (rodapé impresso)
...
wb.properties.description = ("Psi Planner 2 — controle financeiro, agenda e indicadores "
