...
PALETTE = [
    ...
    ("Cinza Médio", "#A6A6A6", "Bordas finas, subtítulos, linhas da agenda", "light"),
...
<style>
  ...
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  body {{
    font-family: "Poppins", "Segoe UI", sans-serif; font-weight: 300;
  ...
  .cover h1 {{ font-family: "Demo Golsuka Kadila", "Playfair Display", serif; font-size: 58px; font-weight: 400; color: #000000; letter-spacing: .004em; line-height: 1.08; }}
  .cover h1 .wine {{ color: #5A1E2A; }}
  .cover .tagline {{ font-style: italic; color: #A6A6A6; font-size: 16px; margin-top: 14px; font-family: "Playfair Display", Georgia, serif; }}
  ...
  .cover .meta b {{ display:block; font-family:"Playfair Display",Georgia,serif; color:#000000; font-size:13px; font-weight:400;}}
  ...
  .sec-title .n {{ font-family:"Playfair Display",Georgia,serif; color:#5A1E2A; font-size:13px; letter-spacing:.1em;}}
  .sec-title h2 {{ font-size:26px; font-weight:400; color:#000000; }}
  ...
  .ov-card .t {{ font-family:"Playfair Display",Georgia,serif; font-size:14px; color:#000000; }}
  .ov-card .t .n {{ color:#A6A6A6; font-size:11px; margin-right:8px; }}
  .ov-card p {{ margin-top:6px; color:#3B3B3B; font-size:10.5px; line-height:1.55; }}
  ...
  .sw-name {{ font-family:"Playfair Display",Georgia,serif; font-size:13px; color:#000000; margin-top:9px; }}
  .sw-uso {{ font-size:9.5px; color:#A6A6A6; margin-top:3px; line-height:1.45; }}
  ...
  .type-card .name {{ font-family:"Playfair Display",Georgia,serif; font-size:30px; color:#000000; margin:6px 0 4px; font-weight:400;}}
  .type-card .name.sans {{ font-family:"Poppins","Segoe UI",sans-serif; font-weight:300; }}
  .type-card .role {{ font-size:10.5px; color:#3B3B3B; line-height:1.6; margin-top:10px; }}
  .type-card .chars {{ margin-top:12px; font-size:10px; color:#A6A6A6; }}
  .type-card .chars span {{ display:inline-block; border:1px solid #EAEAEA; padding:2px 9px; margin:0 5px 5px 0; border-radius:12px; }}
  ...
  .aba-num {{ font-family:"Playfair Display",Georgia,serif; font-size:34px; color:#EBD7DC; line-height:1; }}
  .aba-head h2 {{ font-size:24px; font-weight:400; color:#000000; }}
  .aba-sub {{ font-style:italic; color:#A6A6A6; font-size:12px; font-family:"Playfair Display",Georgia,serif; margin-top:2px; }}
  ...
  .grp h4 {{ font-size:11px; font-weight:400; color:#5A1E2A; letter-spacing:.04em; margin-bottom:5px; padding-bottom:4px; border-bottom:1px solid #EFE2E5; }}
  .grp ul {{ list-style:none; }}
  .grp li {{ position:relative; padding-left:13px; font-size:10px; color:#5A4636; line-height:1.65; }}
  ...
  .note h4 {{ font-family:"Playfair Display",Georgia,serif; font-size:14px; color:#000000; font-weight:400; margin-bottom:9px; }}
  .note ul {{ list-style:none; }}
  .note li {{ position:relative; padding-left:14px; font-size:10px; color:#5A4636; line-height:1.7; }}
...
<body>
  ...
  <section class="page cover">
    ...
    <div class="center">
      <div class="wbar"></div>
      <h1>Psi <span class="wine">Planner 2</span></h1>
    ...
    <div class="foot">Saluti · Projeto Psi Planner 2</div>
  </section>

  <!-- ===================== VISAO GERAL ===================== -->
  <section class="page">
    <div class="sec-title"><span class="n">I</span><h2>Estrutura geral</h2></div>
    <p style="margin-bottom:24px;color:#3B3B3B;max-width:88%;">A planilha é organizada em sete abas interligadas. Toda a navegação acontece por botões com macros VBA, sem rolagem entre planilhas, reproduzindo a experiência de um software clínico boutique.</p>
    <div class="overview">
      ...
      <div class="ov-card" style="background:#5A1E2A;border-color:#5A1E2A;"><div class="t" style="color:#fff;">Navegação VBA</div><p style="color:#E7D2D7;">Botões com hover discreto conectam todas as abas em um clique.</p></div>
    </div>
    <div class="foot-note">Psi Planner 2 — Especificação Visual</div>
  </section>
  ...
  <section class="page">
    ...
    <div class="type-grid">
      ...
      <div class="type-card">
        ...
        <div class="name sans">Poppins Light</div>
      ...
      <div class="type-card">
        <div class="lbl">Subtítulos · Itálico</div>
        <div class="name" style="font-style:italic;">Playfair Display</div>
        <div class="role">Frases institucionais e subtítulos em itálico elegante, logo abaixo dos títulos. 12-14pt.</div>
        <div class="chars"><span>Editorial</span><span>Itálico</span><span>Refinado</span></div>
      </div>
    </div>
    ...
    <div class="notes">
      ...
      <div class="note">
        ...
        <div class="cond">
          ...
          <span class="tag" style="background:#000000;color:#fff;">Cancelado/Faltou — preto</span>
